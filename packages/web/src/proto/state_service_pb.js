...
export const ChannelStateReply = proto3.makeMessageType(
  ...
  () => [
    ...
    {
      no: 4,
      name: "old_nonce_signed_amount",
      kind: "scalar",
      T: 12 /* ScalarType.BYTES */,
    },
    {
      no: 5,
      name: "old_nonce_signature",
      kind: "scalar",
      T: 12 /* ScalarType.BYTES */,
    },
    {
...
export const FreeCallStateRequest = proto3.makeMessageType(
  ...
  () => [
    ...
    {
      no: 2,
      name: "token_for_free_call",
      kind: "scalar",
      T: 12 /* ScalarType.BYTES */,
    },
    {
      no: 3,
      name: "token_expiry_date_block",
      kind: "scalar",
      T: 4 /* ScalarType.UINT64 */,
    },
